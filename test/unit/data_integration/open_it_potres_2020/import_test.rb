...
class DataIntegration::OpenItPotres2020
  class ImportTest < ActiveSupport::TestCase
    ...
    def test_import_single_should_work
      rv = ImportSingle[ImportSingle.mock]

      act_rv = rv[:t].attributes
      exp_rv = {"id"=>"fa89ecb7-a8ef-4938-b8ba-05d06c5f2aa7",
        ...
        "ticket_version"=>10000,
        "contact_phone"=>"0981234123",
        "contact_address" => "",
        "contact_latitude"=>0.3312345e2,
        "contact_longitude"=>0.5512345e2,
